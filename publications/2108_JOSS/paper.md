...
The table below summarizes the current capabilities of OpenCMP. Future work on OpenCMP will focus on adding models - for multi-phase flow, turbulence, and heat transfer - and enabling running simulations in parallel over multiple nodes with MPI [@mpi].
...
|                   | Diffuse interface method                                     |
| Models            | [Poisson (Heat) equation](https://opencmp.io/tutorials/tutorial_2.html)                                     |
|                   | [Stokes](https://opencmp.io/tutorials/tutorial_4.html) equations                                             |
|                   | [Incompressible Navier-Stokes (INS)](https://opencmp.io/tutorials/tutorial_7.html) equations                 |
|                   | [Multicomponent Mixture INS](https://opencmp.io/tutorials/tutorial_9.html) equations                         |
